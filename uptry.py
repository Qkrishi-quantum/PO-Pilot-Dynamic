...
if st.button('Next'):
    if uploaded_files:
        for uploaded_file in uploaded_files:
            ...
            allocation_data['last_day_returns'] = allocation_data['Symbol'].map(last_day_returns)
            allocation_data['first_day_returns'] = allocation_data['Symbol'].map(first_day_returns)
